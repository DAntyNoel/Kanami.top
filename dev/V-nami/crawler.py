...
def build_parser() -> argparse.ArgumentParser:
    ...
    resume_group = crawl_parser.add_mutually_exclusive_group()
    resume_group.add_argument("--resume", dest="resume", action="store_true", help="Resume from existing output JSON and checkpoint (default).")
    resume_group.add_argument("--fresh", dest="resume", action="store_false", help="Start a fresh crawl and overwrite existing output JSON and checkpoint.")
    crawl_parser.set_defaults(resume=True)
